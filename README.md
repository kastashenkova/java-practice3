...
## Реалізація
У файлі кореневої директорії *build.gradle.kts* створили плагін *NetworkPlugin* з 2 тасками, які прописані в окремих класах директорії *buildSrc*, а також через *tasks.register* додали завдання зі створення zip-архіву з вихідним кодом проєкту.
